...
from _util import MAX_UINT32, MAX_UINT8
from _util import logisticmap
from _util import _enc_process, _dec_process
from _util import split_uint8, join_uint8
